...
func (x *ListSampleRequest) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *ListSampleRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *CreateSampleResponse) Reset() {
	*x = CreateSampleResponse{}
	mi := &file_proto_sample_v1_sample_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateSampleResponse) Descriptor() ([]byte, []int) {
	return file_proto_sample_v1_sample_proto_rawDescGZIP(), []int{6}
}
...
func (x *UpdateSampleRequest) Reset() {
	*x = UpdateSampleRequest{}
	mi := &file_proto_sample_v1_sample_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSampleRequest) Descriptor() ([]byte, []int) {
	return file_proto_sample_v1_sample_proto_rawDescGZIP(), []int{7}
}
...
func (x *UpdateSampleResponse) Reset() {
	*x = UpdateSampleResponse{}
	mi := &file_proto_sample_v1_sample_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSampleResponse) Descriptor() ([]byte, []int) {
	return file_proto_sample_v1_sample_proto_rawDescGZIP(), []int{8}
}
...
func (x *DeleteSampleRequest) Reset() {
	*x = DeleteSampleRequest{}
	mi := &file_proto_sample_v1_sample_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSampleRequest) Descriptor() ([]byte, []int) {
	return file_proto_sample_v1_sample_proto_rawDescGZIP(), []int{9}
}
...
func (x *DeleteSampleResponse) Reset() {
	*x = DeleteSampleResponse{}
	mi := &file_proto_sample_v1_sample_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSampleResponse) Descriptor() ([]byte, []int) {
	return file_proto_sample_v1_sample_proto_rawDescGZIP(), []int{10}
}
...
const file_proto_sample_v1_sample_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/sample/v1/sample.proto\x12\tsample.v1\",\n" +
	"\x06Sample\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"=\n" +
	"\x11ListSampleRequest\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x05R\x04page\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\"A\n" +
	"\x12ListSampleResponse\x12+\n" +
	"\asamples\x18\x01 \x03(\v2\x11.sample.v1.SampleR\asamples\"\"\n" +
	...
	"\x06sample\x18\x01 \x01(\v2\x11.sample.v1.SampleR\x06sample\"9\n" +
	...
	"\rSampleService\x12I\n" +
	"\n" +
	"ListSample\x12\x1c.sample.v1.ListSampleRequest\x1a\x1d.sample.v1.ListSampleResponse\x12F\n" +
	"\tGetSample\x12\x1b.sample.v1.GetSampleRequest\x1a\x1c.sample.v1.GetSampleResponse\x12O\n" +
	"\fCreateSample\x12\x1e.sample.v1.CreateSampleRequest\x1a\x1f.sample.v1.CreateSampleResponse\x12O\n" +
	"\fUpdateSample\x12\x1e.sample.v1.UpdateSampleRequest\x1a\x1f.sample.v1.UpdateSampleResponse\x12O\n" +
	"\fDeleteSample\x12\x1e.sample.v1.DeleteSampleRequest\x1a\x1f.sample.v1.DeleteSampleResponseB)Z'clean-template/proto/sample/v1;samplev1b\x06proto3"

var (
	file_proto_sample_v1_sample_proto_rawDescOnce sync.Once
	file_proto_sample_v1_sample_proto_rawDescData []byte
)

func file_proto_sample_v1_sample_proto_rawDescGZIP() []byte {
	file_proto_sample_v1_sample_proto_rawDescOnce.Do(func() {
		file_proto_sample_v1_sample_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_sample_v1_sample_proto_rawDesc), len(file_proto_sample_v1_sample_proto_rawDesc)))
	})
	return file_proto_sample_v1_sample_proto_rawDescData
}

var file_proto_sample_v1_sample_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_sample_v1_sample_proto_goTypes = []any{
	(*Sample)(nil),               // 0: sample.v1.Sample
	(*ListSampleRequest)(nil),    // 1: sample.v1.ListSampleRequest
	(*ListSampleResponse)(nil),   // 2: sample.v1.ListSampleResponse
	(*GetSampleRequest)(nil),     // 3: sample.v1.GetSampleRequest
	(*GetSampleResponse)(nil),    // 4: sample.v1.GetSampleResponse
	(*CreateSampleRequest)(nil),  // 5: sample.v1.CreateSampleRequest
	(*CreateSampleResponse)(nil), // 6: sample.v1.CreateSampleResponse
...
var file_proto_sample_v1_sample_proto_depIdxs = []int32{
	0,  // 0: sample.v1.ListSampleResponse.samples:type_name -> sample.v1.Sample
	0,  // 1: sample.v1.GetSampleResponse.sample:type_name -> sample.v1.Sample
	0,  // 2: sample.v1.CreateSampleResponse.sample:type_name -> sample.v1.Sample
	0,  // 3: sample.v1.UpdateSampleResponse.sample:type_name -> sample.v1.Sample
	1,  // 4: sample.v1.SampleService.ListSample:input_type -> sample.v1.ListSampleRequest
	3,  // 5: sample.v1.SampleService.GetSample:input_type -> sample.v1.GetSampleRequest
	5,  // 6: sample.v1.SampleService.CreateSample:input_type -> sample.v1.CreateSampleRequest
	...
	2,  // 9: sample.v1.SampleService.ListSample:output_type -> sample.v1.ListSampleResponse
	4,  // 10: sample.v1.SampleService.GetSample:output_type -> sample.v1.GetSampleResponse
	6,  // 11: sample.v1.SampleService.CreateSample:output_type -> sample.v1.CreateSampleResponse
...
func file_proto_sample_v1_sample_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_sample_v1_sample_proto_rawDesc), len(file_proto_sample_v1_sample_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
