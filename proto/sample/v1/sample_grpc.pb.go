...
const (
	SampleService_ListSample_FullMethodName   = "/sample.v1.SampleService/ListSample"
...
func (c *sampleServiceClient) ListSample(ctx context.Context, in *ListSampleRequest, opts ...grpc.CallOption) (*ListSampleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSampleResponse)
	err := c.cc.Invoke(ctx, SampleService_ListSample_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSampleServiceServer) ListSample(context.Context, *ListSampleRequest) (*ListSampleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSample not implemented")
}
...
func _SampleService_ListSample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSampleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SampleServiceServer).ListSample(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SampleService_ListSample_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).ListSample(ctx, req.(*ListSampleRequest))
	}
...
var SampleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SampleService_ListSample_Handler,
		},
		{
	...
	Metadata: "proto/sample/v1/sample.proto",
}
